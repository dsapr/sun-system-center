...
import com.dsapr.common.validator.UpdateGroup;
 ...
 */
@Slf4j
public class EntityUpdater<T, ID> extends com.dsapr.jpa.support.BaseEntityOperation implements com.dsapr.jpa.support.Loader<T, ID>, com.dsapr.jpa.support.UpdateHandler<T>, com.dsapr.jpa.support.Executor<T> {
