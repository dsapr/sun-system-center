package codegen.processor;

import codegen.processor.api.*;
import com.dsapr.codegen.context.ProcessingEnvironmentHolder;
import com.dsapr.codegen.processor.controller.GenController;
import com.dsapr.codegen.processor.controller.GenControllerProcessor;
import com.dsapr.codegen.processor.creator.CreatorCodeGenProcessor;
import com.dsapr.codegen.processor.creator.GenCreator;
import com.dsapr.codegen.processor.mapper.GenMapper;
import com.dsapr.codegen.processor.mapper.GenMapperProcessor;
import com.dsapr.codegen.processor.query.GenQuery;
import com.dsapr.codegen.processor.query.GenQueryProcessor;
import com.dsapr.codegen.processor.repository.GenRepository;
import com.dsapr.codegen.processor.repository.GenRepositoryProcessor;
import com.dsapr.codegen.processor.service.GenService;
import com.dsapr.codegen.processor.service.GenServiceImpl;
import com.dsapr.codegen.processor.service.GenServiceImplProcessor;
import com.dsapr.codegen.processor.service.GenServiceProcessor;
import com.dsapr.codegen.processor.updater.GenUpdater;
import com.dsapr.codegen.processor.updater.GenUpdaterProcessor;
import com.dsapr.codegen.processor.vo.GenVo;
import com.dsapr.codegen.processor.vo.VoCodeGenProcessor;
import com.dsapr.codegen.spi.CodeGenProcessor;
import com.dsapr.common.annotation.FieldDesc;
import com.dsapr.common.annotation.TypeConverter;
...
public abstract class BaseCodeGenProcessor implements CodeGenProcessor {
  ...
  public void genJavaSourceFile(String packageName, String pathStr,
    ...
    JavaFile javaFile = JavaFile
        ...
        .addFileComment("---Auto Generated by dsapr ---")
        .build();
//    System.out.println(javaFile);
  ...
  protected void genJavaFile(String packageName, TypeSpec.Builder typeSpecBuilder) {
    JavaFile javaFile = JavaFile.builder(packageName, typeSpecBuilder.build())
        .addFileComment("---Auto Generated by dsapr ---").build();
    try {
